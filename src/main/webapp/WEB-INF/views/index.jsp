	...
	<main>
		<div class="container-fluid px-4">
			...
			<ol class="breadcrumb mb-4">
				<li class="breadcrumb-item active">Data List - ${reponseTableData}</li>
				<div>
					${category}
				</div>
			</ol>
			...
			<div class="row">
				<div class="col-xl-6">
					<div class="card mb-4">
						<div class="card-header">
							<i class="fas fa-chart-area me-1"></i>Download Chart
						</div>
						<div class="card-body">
				...
				<div class="col-xl-6">
					<div class="card mb-4">
						<div class="card-header">
							<i class="fas fa-chart-bar me-1"></i> Program Data Chart
						</div>
						<div class="card-body">
...
<script
	...
	crossorigin="anonymous"></script>
<script src="/jwtauth/assets/chart-area-demo.js"></script>
<script src="/jwtauth/assets/chart-bar-demo.js"></script>
