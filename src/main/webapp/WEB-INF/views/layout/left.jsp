	...
	<div id="layoutSidenav_nav">
		<nav class="sb-sidenav accordion sb-sidenav-dark"
			...
			<div class="sb-sidenav-menu">
				<div class="nav" id="container-menulist">
...
<script type="text/javascript" src="/jwtauth/js/utils.js"></script>
<script type="text/javascript" src="/jwtauth/js/layout/left.js"></script>